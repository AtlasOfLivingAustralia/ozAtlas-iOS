...
#define RFLog(fmt, ...) DebugLog((@"RF: " fmt), ##__VA_ARGS__);
#define RFLogWarning(fmt, ...) DebugLog((@"RF warning: " fmt), ##__VA_ARGS__);
#define RFLogError(fmt, ...) DebugLog((@"RF error: " fmt), ##__VA_ARGS__);
